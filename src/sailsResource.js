...
angular.module('sailsResource', []) .factory('sailsResource', ['$rootScope', '$window', resourceFactory]);

function resourceFactory($rootScope, $window) {
    ...
    return function (model, actions, options) {
        ...
        socket.on(model, function (message) {
            ...
            switch (message.verb) {
                case 'updated': socketUpdateResource(message); break;
                case 'created': socketCreateResource(message); break;
                case 'destroyed': socketDeleteResource(message); break;
            }
        });
